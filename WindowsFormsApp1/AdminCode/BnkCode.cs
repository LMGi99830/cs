...
{
    public partial class BnkCode : Form
    {
        ...
        public void btn_enrollment()
        {
            ...
            // 오라클 연결
            string queryString = "select * from P22_LMG_TATM_BNK where BNK_CODE = '" + textBox1.Text + "'";
            using (OracleConnection connection = new OracleConnection(cs))
            {
                ...
                else
                {
                    ...
                    command.CommandText = "INSERT INTO P22_LMG_TATM_BNK(BNK_CODE, BNK_NAME) VALUES('" + textBox1.Text + "','" + textBox2.Text + "')";
        ...
        public void btn_update()
        {
            ...
            cmdd.Connection = con;
            cmdd.CommandText = "UPDATE P22_LMG_TATM_BNK SET BNK_NAME = '" + textBox2.Text + "' WHERE BNK_CODE = '" + textBox1.Text + "'";
        ...
        public void btn_delete()
        {
            ...
            String sql = "select * from p22_lmg_tatm_stu where stu_acc_bank = '"+ indexvalue + "'";
            ...
            {
                cmdd.CommandText = "DELETE P22_LMG_TATM_BNK WHERE BNK_CODE = '" + indexvalue + "'";
        ...
        public void Search1_Click()
        {
            con = new OracleConnection(cs);
            con.Open();
            adapt = new OracleDataAdapter("select * from P22_LMG_TATM_BNK where BNK_CODE like '" + textBox1.Text + "%' and BNK_NAME like '" + textBox2.Text + "%' order by BNK_CODE", con);
            dt = new DataTable();
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
