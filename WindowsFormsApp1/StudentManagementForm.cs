...
namespace WindowsFormsApp1
{
    public partial class StudentManagementForm : Form
    {
        ...
        public void reset_student()
        {
            ...
            conn.Open();
            adaptt = new OracleDataAdapter("select stu_stuno, stu_resno, stu_name, stu_fix, def_code ,stu_depart," +
                "stu_phone, stu_email, stu_zip, stu_zipaddr, stu_addr, stu_dor_use, don_name, stu_dor_don, stu_dor_mb,BNK_CODE ,stu_acc_bank," +
                "stu_acc_name, stu_acc_no, stu_img, datasys1, datasys2, datasys3 from p22_lmg_tatm_stu s , P22_LMG_TATM_DEF f, P22_LMG_TATM_DON d," +
                "P22_CJB_TATM_BNK b where s.STU_DEPART = f.DEF_NAME and s.STU_DOR_DON = d.DON_CODE and s.STU_ACC_BANK = b.BNK_NAME", conn);
            dtt = new DataTable();
            adaptt.Fill(dtt);
